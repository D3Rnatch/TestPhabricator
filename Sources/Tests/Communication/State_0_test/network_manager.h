...
class Network_manager
{
	public :
		...
		void send_dbg_message_to_computer(char *);
		void send_dbg_message_to_user(char *);
		// void send_data_to_computer(char);
		void send_data_to_computer(char);
		void send_data_to_user(char);
	
		char *read_data_from_buffer();
		void write_data_to_buffer(char *, int);
