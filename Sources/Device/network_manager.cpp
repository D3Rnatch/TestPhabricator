...
Network_manager::Network_manager(long baud)
{
    Serial.begin(baud);
    Serial.flush();
...
void Network_manager :: send_data_packet(uint8_t v1, uint8_t v2, uint8_t v3, uint8_t v4)
{
	t_encap t = encap_acq_data(v1,v2,v3,v4);
	this->send_packet(&t);
}
